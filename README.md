...
Steal The Treasure to gra platformowa, w której gracz eksploruje trzy poziomy, znajduje ulepszenia pomocne w dalszej rozgrywce, zbiera elementy kodu do kłódki i po jego poprawnym wpisaniu odblokowuje skarb i wygrywa.
## Controls
...
- **Skeleton Enemy** [Hero nad Opponents Animation](https://assetstore.unity.com/packages/2d/characters/hero-nad-opponents-animation-140776#publisher) by Szadi Art
- **Zombie Enemy** [Free Urban Zombie Sprite Sheet Pixel Art Pack](https://craftpix.net/freebies/free-urban-zombie-sprite-sheet-pixel-art-pack/) 
- **Wizard Enemy** [Free Wizard Sprite Sheets Pixel Art](https://craftpix.net/freebies/free-wizard-sprite-sheets-pixel-art/)
### Tile set
...
- **Attack sound** [monster bite](https://pixabay.com/sound-effects/horror-monster-bite-44538/) by soundmast123 (Freesound)
#### Fireball
